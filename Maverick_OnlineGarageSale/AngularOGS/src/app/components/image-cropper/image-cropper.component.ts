...
export class ImageCropperComponent implements OnChanges {
  ...
  private resizeCropperPosition() {
    ...
    if (
      ...
      this.cropper.x1 =
        (this.cropper.x1 * displayedImage.offsetWidth) / this.maxSize.width;
      this.cropper.x2 =
        (this.cropper.x2 * displayedImage.offsetWidth) / this.maxSize.width;
      this.cropper.y1 =
        (this.cropper.y1 * displayedImage.offsetHeight) / this.maxSize.height;
      this.cropper.y2 =
        (this.cropper.y2 * displayedImage.offsetHeight) / this.maxSize.height;
    }
  }
